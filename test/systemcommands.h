...
const std::string startprocess = "startprocess";

const std::string stopprocess = "stopprocess";
const std::string pauseprocess = "pauseprocess";
const std::string heaterTemperatures = "heaterTemperatures";
